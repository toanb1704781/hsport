    ...
    <section class="content">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">THÊM MỚI SLIDER HIỂN THỊ TRÊN TRANG CHỦ</h3>
            </div>
            <form action="{{route('slider.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="sliderDesc" name="sliderDesc">
                    </div>
                    <div class="form-group">
                        <label for="sliderSlug">Đường dẫn</label>
                        <input type="text" class="form-control" id="sliderSlug" name="sliderSlug" value="" >
                    </div>
                </div>
