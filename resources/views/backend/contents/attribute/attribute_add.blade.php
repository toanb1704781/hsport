    ...
    <section class="content">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Thêm màu sắc mới</h3>
            </div>
            <form action="{{route('thuoc-tinh.store')}}" method="POST">
                @csrf
                <div class="card-body">
                    <div class="form-group">
                        <label for="colorName">Màu</label>
                        <input type="text" class="form-control" id="colorName" name="colorName" placeholder="Màu sắc">
                    </div>
                    <div class="form-group">
                        <label for="colorCode">Mã màu</label> <br>
                        <input type="color" class="" id="colorCode" name="colorCode" placeholder="Mã màu">
                    </div>
                </div>
