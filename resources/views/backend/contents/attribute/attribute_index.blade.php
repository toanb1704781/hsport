    ...
    <div class="row">
      <div class="col-sm-12">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Thuộc tính giày</li>
        </ol>
        <hr>
      </div>
      <div class="col-sm-6">
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <a class="btn btn-success btn-sm" href="{{route('thuoc-tinh.create')}}">
              ...
              <tbody>
                @foreach ($color as $color)
                  <tr>
                    ...
                    <td>
                      <form action="{{route('thuoc-tinh.destroy', ['thuoc_tinh' => $color->colorID])}}" method="post">
                        @csrf
                        @method('delete')
                        <a class="btn btn-primary btn-sm" href="{{route('thuoc-tinh.edit',['thuoc_tinh' => $color->colorID])}}">
                          <i class="far fa-edit"></i>
                        </a>
                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#mau{{$color->colorID}}">
                          <i class="fas fa-trash"></i>
                        </button>
                        <div class="modal fade" id="mau{{$color->colorID}}">
                          <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h4 class="modal-title">
                                  Bạn có muốn xóa màu <strong>{{$color->colorName}}</strong> ?
                                </h4>
                              </div>
