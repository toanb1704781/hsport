            ...
            <form action="{{route('nha-cung-cap.store')}}" method="POST">
                ...
                <div class="card-body">
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="supName" name="supName" placeholder="Tên nhà cung cấp">
                  </div>
                  <div class="form-group">
                    <label for="supAddress">Địa chỉ</label>
                    <input type="text" class="form-control" id="supAddress" name="supAddress" placeholder="Nhập địa chỉ">
                  </div>
                  <div class="form-group">
                    <label for="supPhone">Số điện thoại</label>
                    <input type="text" class="form-control" id="supPhone" name="supPhone" placeholder="Nhập số điện thoại">
                  </div>
                  <div class="form-group">
                    <label for="supEmail">Email</label>
                    <input type="text" class="form-control" id="supEmail" name="supEmail" placeholder="Nhập email">
                  </div>
                </div>
